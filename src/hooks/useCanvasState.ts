...
import { CanvasState, CanvasActions, GoJSNodeData, GoJSLinkData } from '../types/canvas';
...
export const useCanvasState = () => {
  ...
  // Editor states
  const [selectedNode, setSelectedNode] = useState<GoJSNodeData | null>(null);
  const [selectedLink, setSelectedLink] = useState<GoJSLinkData | null>(null);
