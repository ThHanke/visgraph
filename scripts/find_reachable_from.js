#!/usr/bin/env node
// scripts/find_reachable_from.js
// Conservative static import graph resolver (regex-based) to compute reachable files
// Usage: node scripts/find_reachable_from.js <entry-file>
...
if (!entry) {
  console.error('Usage: node scripts/find_reachable_from.js <entry-file (relative to project root)>');
  process.exit(2);
}
